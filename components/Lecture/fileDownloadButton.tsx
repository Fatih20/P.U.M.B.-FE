export default function FileDownloadButton({ url }: { url: string }) {
    return (
        <>
            ...
            <div className="flex p-3 rounded-lg shadow-lg bg-white w-full">
                <div className="w-10/12 flex items-center ">
                    <div className="flex items-center  space-x-1 w-100">
                        ...
                        <span>This is the pdf file name.pdf</span>
                    </div>
                </div>
                <button className="w-2/12 flex items-center justify-center  bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
